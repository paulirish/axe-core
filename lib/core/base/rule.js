...
Rule.prototype.run = function (context, options, resolve, reject) {
	...
	if (options.performanceTimer) {
		...
		var rule = this;
		var markStart = 'mark_runchecks_start_' + rule.id;
		var markEnd = 'mark_runchecks_end_' + rule.id;
	...
	if (options.performanceTimer) {
		...
		axe.utils.performanceTimer.measure('runchecks_' + rule.id, markStart, markEnd);
	}
